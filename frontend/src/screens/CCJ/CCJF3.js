// CCJF3.js — News / Event / Announcement panel (Gray & Black theme)
...
export default function CCJF3({ navigation }) {
    ...
    <View style={m.container}>
      <View style={m.leftColumn}>
        ...
        <Animated.View {...responders[0].panHandlers} style={[m.cardWrapper, cardAnimatedStyle(0)]}>
          <Animated.View style={[m.card, m.gradientCardTop]}>
            ...
            <Animated.View style={[m.gloss, { opacity: 0.18, transform: [{ translateX: shimmerTranslate }, { rotate: '22deg' }] }]} />
        ...
        <Animated.View {...responders[1].panHandlers} style={[m.cardWrapper, cardAnimatedStyle(1)]}>
          <Animated.View style={[m.card, m.gradientCardSmall]}>
            ...
            <Animated.View style={[m.glossSmall, { opacity: 0.14, transform: [{ translateX: shimmerTranslate }, { rotate: '18deg' }] }]} />
      ...
      <Animated.View {...responders[2].panHandlers} style={[m.cardWrapper, cardAnimatedStyle(2)]}>
        <Animated.View style={[m.card, m.gradientCardRight]}>
          ...
          <Animated.View style={[m.gloss, { opacity: 0.14, transform: [{ translateX: shimmerTranslate }, { rotate: '20deg' }] }]} />
  ...
  return (
    <SafeAreaView style={s.screen}>
      ...
      <BottomPager navigation={navigation} activeIndex={1} targets={['CCJF2', 'CCJF3', 'CCJF4']} />
    </SafeAreaView>
  );
}
...
const m = StyleSheet.create({
  ...
  innerShadow: { position: 'absolute', top: 0, left: 0, right: 0, height: '52%', backgroundColor: 'rgba(0,0,0,0.18)' },
  innerShadowSmall: { position: 'absolute', top: 0, left: 0, right: 0, height: '46%', backgroundColor: 'rgba(0,0,0,0.14)' },
  innerShadowRight: { position: 'absolute', top: 0, left: 0, right: 0, height: '48%', backgroundColor: 'rgba(0,0,0,0.15)' },
  gloss: { position: 'absolute', left: -70, top: -30, width: 100, height: 240, backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 80 },
  glossSmall: { position: 'absolute', left: -50, top: -20, width: 80, height: 160, backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 70 },
  cardGlow: { position: 'absolute', bottom: -8, width: 160, height: 22, borderRadius: 12, backgroundColor: 'rgba(220,220,220,0.06)' },
  bigImage: { width: 120, height: 120, tintColor: undefined },
