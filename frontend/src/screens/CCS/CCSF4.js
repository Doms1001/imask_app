...
// CCSF4 — red/orange gradient cards + shimmer + glow + 3D press/tilt
    ...
    <SafeAreaView style={s.screen}>
      ...
      <View style={s.centerContainer}>
        ...
        <Animated.View {...responders[0].panHandlers} style={[s.topWrapper, cardAnimatedStyle(0)]}>
          <TouchableWithoutFeedback onPress={() => handlePress(0, 'CCSF8')} onPressIn={() => pressScales[0].setValue(0.96)} onPressOut={() => pressScales[0].setValue(1)}>
