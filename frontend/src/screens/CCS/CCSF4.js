...
// STUDENT ESSENTIALS — CCS THEME (RED + BLACK) MATCHING CCSF3
...
export default function CCSF4({ navigation }) {
  ...
  // FIX: Remove slice-bug by reducing XY tilting force
  const tilt = [
  ...
  function makeResponder(i) {
    return PanResponder.create({
      ...
      onMoveShouldSetPanResponder: () => false, // FIX: prevent slice-bug
      onPanResponderGrant: () => {
      ...
      <View style={m.container}>
        <View style={m.leftColumn}>
          ...
          >
            <Animated.View style={[m.card, m.cardLarge]}>
              ...
              />
              <TouchableWithoutFeedback onPress={() => handlePress(0, "CCSF8")}>
          ...
          >
            <Animated.View style={[m.card, m.cardSmall]}>
              ...
              />
              <TouchableWithoutFeedback onPress={() => handlePress(1, "CCSF10")}>
                <View style={m.centered}>
        ...
        >
          <Animated.View style={[m.card, m.cardRight]}>
            ...
            <TouchableWithoutFeedback onPress={() => handlePress(2, "CCSF9")}>
              <View style={m.centered}>
...
const m = StyleSheet.create({
  ...
  cardGlow: {
    ...
    height: 22,
    borderRadius: 12,
    backgroundColor: "rgba(255,66,61,0.25)", // CCS red glow
  },
