...
export default function CCSF3({ navigation }) {
    ...
    <View style={m.container}>
      <View style={m.leftColumn}>
        ...
        <Animated.View style={[m.cardWrapper, cardAnimatedStyle(0)]}>
          ...
          >
            ...
            <Animated.View
              style={[m.cardGlow, { opacity: glowOpac[0] }]}
            />
          </LinearGradient>
        </Animated.View>
        ...
        <Animated.View style={[m.cardWrapper, cardAnimatedStyle(1)]}>
          ...
          >
            ...
            <Animated.View
              style={[m.cardGlow, { opacity: glowOpac[1] }]}
            />
          </LinearGradient>
        </Animated.View>
      </View>
      ...
      <Animated.View style={[m.cardWrapper, cardAnimatedStyle(2)]}>
        ...
        >
          ...
          <Animated.View
            style={[m.cardGlow, { opacity: glowOpac[2] }]}
          />
        </LinearGradient>
      </Animated.View>
    </View>
  ...
  return (
    <SafeAreaView style={s.screen}>
      ...
      {/* just keeps space for layout / dynamic height */}
      <View
        style={s.contentWrap}
      />
