        ...
        >
          <Animated.View style={[m.card, m.gradientCardTop]}>
            ...
            <Animated.View
              style={[
                m.cardGlow,
                { opacity: glowOpac[0], backgroundColor: "rgba(140,70,220,0.18)" },
              ]}
            />
          </Animated.View>
        </Animated.View>
        ...
        >
          <Animated.View style={[m.card, m.gradientCardSmall]}>
            ...
            <Animated.View
              style={[
                m.cardGlow,
                { opacity: glowOpac[1], backgroundColor: "rgba(160,100,230,0.16)" },
              ]}
            />
          </Animated.View>
        </Animated.View>
      ...
      >
        <Animated.View style={[m.card, m.gradientCardRight]}>
          ...
          <Animated.View
            style={[
              m.cardGlow,
              { opacity: glowOpac[2], backgroundColor: "rgba(140,80,220,0.18)" },
            ]}
          />
        </Animated.View>
      </Animated.View>
...
const m = StyleSheet.create({
  ...
  cardGlow: {
    ...
    height: 22,
    borderRadius: 12,
    backgroundColor: "rgba(160,100,230,0.16)",
  },
